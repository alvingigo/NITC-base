...
int Frontend::print_table(char relname[ATTR_SIZE]){
    return Algebra::print(relname);

}

int Frontend::select_from_table(char relname_source[ATTR_SIZE], char relname_target[ATTR_SIZE]) {
  
  return Algebra::project(relname_source,relname_target); // working
...
int Frontend::select_attrlist_from_table(char relname_source[ATTR_SIZE], char relname_target[ATTR_SIZE],
  ...
  return Algebra::project(relname_source,relname_target,attr_count,attr_list); //working

}

int Frontend::select_from_table_where(char relname_source[ATTR_SIZE], char relname_target[ATTR_SIZE],
                                      char attribute[ATTR_SIZE], int op, char value[ATTR_SIZE]) {
  return Algebra::select(relname_source, relname_target, attribute, op, value);//seg error
}
